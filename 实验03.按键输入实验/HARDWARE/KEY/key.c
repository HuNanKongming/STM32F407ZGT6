...
void KEY_Init(void)
{
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_9|GPIO_Pin_8|GPIO_Pin_7; //KEY0 KEY1 KEY2对应引脚
  ...
  GPIO_InitStructure.GPIO_Pin = GPIO_Pin_6;//WK_UP对应引脚PA0
  GPIO_InitStructure.GPIO_PuPd = GPIO_PuPd_UP ;//下拉
  GPIO_Init(GPIOF, &GPIO_InitStructure);//初始化GPIOA0
