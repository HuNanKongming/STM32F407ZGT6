  ...
  if(USART_GetITStatus(USART1, USART_IT_RXNE) != RESET)  //接收中断
    {
      ...
      if(rec_data=='S')		  	                         //如果是S，表示是命令信息的起始位
        ...
        {
          if(strcmp("全速打开压面机正转",(char *)receive_str)==0)
            {
              LED0=!LED0;
              ...
              printf("压面机正在执行正全速转\r\n");
						...
						else if(strcmp("半速打开压面机正转",(char *)receive_str)==0)
            {
              LED1=!LED1;
              GPIO_SetBits(GPIOD,GPIO_Pin_12);
              GPIO_ResetBits(GPIOD,GPIO_Pin_13);
          ...
          else if(strcmp("全速打开压面机反向",(char *)receive_str)==0)
            {
          ...
          else if(strcmp("半速打开压面机反向",(char *)receive_str)==0)
            {
              ...
              uart1SendChars("反向半速转动压面机\r\n",20);
						...
						else if(strcmp("关闭压面机",(char *)receive_str)==0)
						{
							GPIO_ResetBits(GPIOD,GPIO_Pin_12);
							GPIO_ResetBits(GPIOD,GPIO_Pin_13);
							n=0;
              TIM_SetCompare1(TIM1,n);
					...
					//抽水泵控制
					 else if(strcmp("打开抽水泵",(char *)receive_str)==0)
					{
							//对揉面机进行控制
								water_suction_pump_open();
					}
					 else if(strcmp("关闭抽水泵",(char *)receive_str)==0)
					{
							//对揉面机进行控制
