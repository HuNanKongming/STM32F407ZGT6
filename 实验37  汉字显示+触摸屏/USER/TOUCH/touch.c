...
LCD_DisplayString(120,150,16,"Clear");//显示清屏区域
	...
	while(1)
	{
		XPT2046_Scan(0); 		 
			...
			{	
				...
				if(Xdown>100&&Xdown<140&&Ydown>230&&Ydown<270) LED2=0;  //清空屏幕
				else if(Xdown>100&&Xdown<140&&Ydown>290&&Ydown<330) LED2=1;  //清空屏幕
