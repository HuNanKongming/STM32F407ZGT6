...
u16 picture_getcolor(u8 mode,u8 *str);//获取颜色
void picture_show(u16 xsta,u16 ysta,u16 xend,u16 yend,u8 scan,u8 *p);//在指定区域开始显示图片
void picture_display(u16 x,u16 y,u8 * imgx);//在指定位置显示图片
